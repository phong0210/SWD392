...
const AdminRouter = () => {
  ...
  return role === Role.HeadOfficeAdmin || role === Role.StoreManager ? (
    <AdminLayout />
  ) : (
    <Navigate to="/" />
  );
...
const AdminRoutes = {
  ...
  children: [
    ...
    {
      path: config.routes.admin.ringSettingProduct,
      element: <JewelrySetting />,
    },
    {
      path: config.routes.admin.ringSettingDetail,
      element: <JewelrySettingDetail />,
    },
    {
      path: config.routes.admin.jewelryTypeProduct,
      element: <JewelryTypeProduct />,
    },
    ...
    {
      path: config.routes.admin.discountDetail,
    ...
    {
      path: config.routes.admin.deliveryStaffDetail,
      element: <DeliStaffDetail />,
    },
