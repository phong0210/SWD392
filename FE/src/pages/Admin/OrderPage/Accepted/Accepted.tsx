    ...
    const fetchData = async () => {
      try {
        ...
        if (orderList && orderList.data) {
          console.log('Raw order data for Admin Accepted:', orderList.data);
          ...
          setOrder(formatOrderList.filter((order: DataType) => order.status === OrderStatus.ACCEPTED));
          console.log('Formatted and filtered order list:', formatOrderList.filter((order: DataType) => order.status === OrderStatus.ACCEPTED));
        } else {
