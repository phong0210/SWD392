...
const Vip = () => {
  ...
  return (
    <div>
      ...
      <MainContainer>
        <Section>
          <ProfileTitle>VIP Information</ProfileTitle>
          <InfoSection>
            <InfoContainer>
              <Column>
                <Row>
                  <InfoTitle>Your VIP Details</InfoTitle>
                </Row>
                {vipInfo ? (
                  <DataGrid>
                    <DataColumn>
                      <DetailGroup>
                        <Label>TIER</Label>
                        <Detail>{vipInfo.tier}</Detail>
                      </DetailGroup>
                      <DetailGroup>
                        <Label>START DATE</Label>
                        <Detail>
                          {vipInfo.startDate
                            ? formatDate(vipInfo.startDate)
                            : "N/A"}
                        </Detail>
                      </DetailGroup>
                      <DetailGroup>
